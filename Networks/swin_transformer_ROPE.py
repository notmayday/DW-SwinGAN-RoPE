...
class WindowAttention(nn.Module):
    ...
    def apply_rotation(self, tensor, cos, sin):
        tensor_clone = tensor.clone()
        # tensor_clone[..., 0::2] = tensor[..., 1::2]
        # tensor_clone[..., 1::2] = -tensor[..., 0::2]
        tensor_clone[..., 0::2] = -tensor[..., 1::2]
        tensor_clone[..., 1::2] = tensor[..., 0::2]
        tensor = tensor * cos + tensor_clone * sin
        return  tensor
...
class SwinTransformerSys_ROPE(nn.Module):
    r""" Swin Transformer
